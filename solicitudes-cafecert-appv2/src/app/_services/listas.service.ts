...
export class ListasService {
    ...
    obtenerListaPlantas(variable: any) {
        var {  frontend, next, sessionid } = variable;

        return this.http.post<any>(`${process.env.CERTIFBUSINESS}` + '/cafecert/plantallfound/', {
            "frontend": frontend,
            "next": next,
            "sessionid": sessionid
        })
    ...
    ultimaSolicitudPorCodSolicitud(variable: any) {
        var { rol, sesionid, frontend, next, txCodRequest } = variable;

        return this.http.post<any>(`${process.env.REQUESTBUSINESS}` + '/cafecert/lastrequest/cdrequest/', {
            "frontend": frontend,
            "next": next,
            "sessionid": sesionid,
            "txRole": rol,
    ...
    crearSolicitud(variable: any) {
        var { frontend, next, sesionid, rol, sanitaryStd, identifyPrc, declare, certificationType, 
            ...
            nuregthresher, nuregtoaster, nuregsolubilizer, nuregextract, listProgramDOR } = variable;
    ...
    crearMarca(variable: any) {
        var { cdProduct, sesionid, frontend, next, txName, txReference, cdCoffeeType, txPresentation, cdPlant, creationUser, country,coffeeOwner } = variable;
        ...
        return this.http.post<any>(`${process.env.INFOBASEBUSINES}` + '/cafecert/trademark/create/', {
           ...
           // "txName": txName,
            //"txReference": txReference,
            //"cdProductType": cdCoffeeType,
            "user": creationUser,
            "cdProduct":cdProduct,
            "txPresentation": txPresentation,
            "cdPlant": cdPlant,
            "coffeeOwner": coffeeOwner,
            "country": country
        }).pipe(map(response => response || {}));
    }
    ...
    crearProdCertiRelation(variable: any) {
        var { cdProgramType, cdRequest, cdPlant, cdProductType, txPresentation,
            coffeeOwner, country, txName, txReference, txActive, txCreationUser, frontend,
            next, sessionid, txRole } = variable;

        return this.http.post<any>(`${process.env.CERTIFBUSINESS}` + '/cafecert/prodcertirelation/', {
    ...
    eliminarProdCertiRelation(variable: any) {
        var { certificateProductId, productId,certificateId,frontend,
            requestId, productTypeId,programTypeId,txApproved,
            userrole,next, sessionid, txRole } = variable;

        return this.http.post<any>(`${process.env.CERTIFBUSINESS}` + '/cafecert/prodcertirelationdel/', {
           "certificateProductId": certificateProductId,
           "productId": productId,
    ...
    crearProdRelatBTWCertProd(variable: any) {
        var { cdCertificate, cdProgramType, cdRequest, cdPlant, cdProductType, txPresentation,
            coffeeOwner, country, txName, txReference, txActive, txCreationUser, frontend,
            next, sessionid, txRole } = variable;

        return this.http.post<any>(`${process.env.CERTIFBUSINESS}` + '/cafecert/prodrelatbtwcertprod/', {
    ...
    certificadovacio(variable: any) {
        var { rol, sesionid, frontend, next } = variable;

        //console.log("variable : " + variable);
        return this.http.post<any>(`${process.env.CERTIFBUSINESS}` + '/cafecert/certificatelist/empty/', {
            "frontend": frontend,
            "next": next,
            "sessionid": sesionid,
            "txRole": rol
    ...
    tipoProgramaAll(variable: any) {
        ...
        return this.http.post<any>(`${process.env.CERTIFBUSINESS}` + '/cafecert/programtypeallfound/', {
            "frontend": frontend,
            "next": next,
            "sessionid": sessionid,
            "userrole": userrole,
    ...
    actividadIndustrialAll(variable: any) {
        var { frontend, next, sessionid, userrole, action } = variable;
    ...
    presentacionPruductoAll(variable: any) {
        var { frontend, next, sessionid, userrole, action } = variable;

        //console.log("variable : " + variable);
        return this.http.post<any>(`${process.env.CERTIFBUSINESS}` + '/cafecert/ppresentationallfound/', {
            "frontend": frontend,
            "next": next,
            "sessionid": sessionid,
            "userrole": userrole
    ...
    pruductoTypeAll(variable: any) {
        var { frontend, next, sessionid, userrole, action } = variable;

        //console.log("variable : " + variable);
        return this.http.post<any>(`${process.env.CERTIFBUSINESS}` + '/cafecert/producttypeallfound/', {
            "frontend": frontend,
            "next": next,
            "sessionid": sessionid,
            "userrole": userrole
    ...
    productosByRequest(variable: any) {
        var { request, userrole, sesionid, frontend, next } = variable;
        /*console.log(JSON.stringify({
            "frontend": frontend,
            "next": next,
            "sessionid": sesionid,
        ...
        return this.http.post<any>(`${process.env.CERTIFBUSINESS}` + '/cafecert/certificateproductorq/', {
            "frontend": frontend,
            "next": next,
            "sessionid": sesionid,
            "userrole": userrole,
